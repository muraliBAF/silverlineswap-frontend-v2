...
import { State, NodeRound, ReduxNodeLedger, NodeLedger, ReduxNodeRound, PredictionStatus, PredictionsState } from '../types'
...
export const useGetIsClaimableSLN = (epoch) => {
  const claimableStatusesSln = useSelector((state: State) => state.predictions.claimableStatusesSln)
  return claimableStatusesSln[epoch] || false
}
/**
