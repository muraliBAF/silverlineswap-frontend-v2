...
export enum HistoryFilter {
  ALL = 'all',
  COLLECTEDBNB = 'collected_bnb',
  UNCOLLECTEDBNB = 'uncollected_bnb',
  COLLECTEDSLN= 'collected_sln',
  UNCOLLECTEDSLN = 'uncollected_sln',
}
...
export interface ReduxNodeRound {
  epoch: number
  epoch_valid_till: number | null //eslint-disable-line camelcase
...
export interface PredictionConfig {
  ...
  minPriceUsdDisplayed: BigNumber
