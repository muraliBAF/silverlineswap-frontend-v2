...
const ListRow = memo(function ListRow({ listUrl }: { listUrl: string }) {
  ...
  return (
    <RowWrapper active={isActive} key={listUrl} id={listUrlRowHTMLId(listUrl)}>
      ...
      <Column style={{ flex: '1' }}>
        <Row>
          <Text color='text' bold>{list.name}</Text>
        </Row>
        <RowFixed mt="4px">
          <Text color='text' fontSize="12px" mr="6px" textTransform="lowercase">
            ...
            <RowBetween>
              <RowFixed>
                ...
                <AutoColumn gap="4px" style={{ marginLeft: '20px' }}>
                  <Text color='text' bold>{tempList.name}</Text>
                  <Text color='text' small textTransform="lowercase">
