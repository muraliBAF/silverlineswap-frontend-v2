 ...
 */
export const GRAPH_API_PREDICTION_V1 = 'https://api.thegraph.com/subgraphs/name/muralibaf/silverlineswap-prediction-v3'

export const INFO_CLIENT = 'https://api.thegraph.com/subgraphs/name/top1st/silverlineswap'
