...
import { Box, Flex, FlexProps, Link, ProfileAvatar, SubMenu, SubMenuItem, useModal, Text, Image } from '@pancakeswap/uikit'
...
`
const SubMenuSilver = styled(SubMenu)`
      ...
      component={
        <Flex alignItems="center" {...props}>
          ...
          >
            ...
            <Image src='/images/tokens/sln.png' alt='' height={40} width={40} />
          </AvatarWrapper>
        </Flex>
      }
