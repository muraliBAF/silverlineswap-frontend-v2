...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in SLCT prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        <Text color="white" bold fontSize="16px">
          {t('Undocking our NFT soon on the DEX planet')}
        </Text>
        {pretext && (
        ...
        {/* <Text color="white" mb="40px">
          {t('Buy tickets with SLCT, win SLCT if your numbers match')}
        </Text> */}
      </Flex>
