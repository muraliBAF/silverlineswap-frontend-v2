  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active SilverlineSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold SLCT'),
      bodyText: [t('Each NFT costs SLCT to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://www.silverlineswap.finance/swap?outputCurrency=0xC8B7fE1d6B2A7b21D44D2239831Ac6079A471E16"
            target="_blank"
            width="100%"
          >
            {t('Buy SLCT')}
